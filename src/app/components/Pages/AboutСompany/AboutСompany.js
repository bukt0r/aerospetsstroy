const AboutСompany = () => {
  return(
    <div
      id="AboutСompany"
      className="flex flex-col lg:flex-row pl-[15px] pr-[19px] pt-[60px] pb-[60px] text-[#FFFFFFCC] bg-[url('/aboutCompanyBackground.svg')] bg-cover bg-center h-[100vh] w-full lg:bg-[url('/aboutCompanyFullScreen.svg')] lg:px-[60px] lg:py-[100px] lg:justify-between">
      <div>
