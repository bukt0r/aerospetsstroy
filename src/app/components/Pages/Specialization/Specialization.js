const Specialization = () => {
  return(
    <div
      id="Specialization"
      className="flex flex-col pl-[15px] pr-[19px] pt-[60px] pb-[60px] text-[#FFFFFFCC] bg-[url('/specializationBackground.svg')] bg-cover bg-center h-[100vh] w-full lg:bg-[url('/specializationBackgroundFullScreen.svg')] lg:flex-row lg:pt-[100px] lg:pl-[58px] lg:pr-[38px] lg:justify-between">
      <div className="">
